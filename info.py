...
API_ID = int(environ.get('API_ID', '39578593'))
API_HASH = environ.get('API_HASH', 'ef61d45204a158a46a4fb2e65ac664b5')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6764644919 5822066085').split()] # For Multiple Id Use One Space Between Each.
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '6764644919 5822066085').split()]  # For Multiple Id Use One Space Between Each.
AUTH_USERS = (auth_users + ADMINS) if auth_users else []

# This Channel Is For When User Start Your Bot Then Bot Send That User Name And Id In This Log Channel, Same For Group Also.
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003963818425'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003776668091').split()]  # For Multiple Id Use One Space Between Each.
...
reqst_channel = environ.get('REQST_CHANNEL', '-1003924299203')
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-5168831008')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None

# This Channel Is For /batch command file store.
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1003966144046')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://shadow:Db110088!@cluster0.4wrl7xo.mongodb.net/?appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/CineVerseSearch')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/CineVerseUpdates10x')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'CineVerseSupport') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/LordShadow10x')
...
VERIFY_SHORTLINK_URL = environ.get('VERIFY_SHORTLINK_URL', 'https://vplink.in/')
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', 'f9c78863ffb0e2886f21820f11cf360b765541b0')
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/CineVerseSupport/3')
